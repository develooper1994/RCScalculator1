...
% tline: Okunan tüm karakterler
% lt: okunan yeni karakterler?. Buradan kaç yeni karakter varsa o kadar
% eliyor.
%   [TLINE, LTOUT] = FGETS(...) also returns the LINE TERMINATOR(s), if any, in
%   LTOUT. genelde 10 yada 13 oluyor.

[tline,lt] = fgets(fid); % kod üretilemiyor.
% [tline,lt] = readAllFile(fid); % kod üretilebiliyor. DÝKKAT! Üzerinde deðiþiklik yaptým.
